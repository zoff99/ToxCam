...
void left_top_bar_into_yuv_frame(uint8_t *yy, uint8_t *uu, uint8_t *vv, int ww, int hh, int bar_start_x_pix,
                                 int bar_start_y_pix, int bar_w_pix, int bar_h_pix, uint8_t r, uint8_t g, uint8_t b);
void print_font_char(uint8_t *yy, uint8_t *uu, uint8_t *vv, int ww, int hh, int start_x_pix, int start_y_pix,
                     int font_char_num, uint8_t col_value);
void text_on_yuf_frame_xy(uint8_t *yy, uint8_t *uu, uint8_t *vv, int ww, int hh, int start_x_pix, int start_y_pix,
                          const char *text);
void blinking_dot_on_frame_xy(uint8_t *yy, uint8_t *uu, uint8_t *vv, int ww, int hh, int start_x_pix, int start_y_pix,
                              int dot_w, int dot_h, int *state);
...
const char *my_toxid_filename_txt = "./db/toxid.txt";
...
{
    dbg(9, "group_audio_callback_func:fnum=%d ch=%d samplerate=%d\n", peernumber, channels, sample_rate);
}
